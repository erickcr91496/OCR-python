...
#    # etapa de procesamiento 
#    pre_procesamiento = Procesamiento(path)
#    placa_img = pre_procesamiento.placa()
#    # pre_procesamiento.show_placa()
...
##BOTONES........************/////////////
btnOpenFile =Button(miFrame, text="Cargar Imagen del vehiculo", command= open_data, width="30", height="2", bg="#E9CA45" ).place(x=225,y=50)
